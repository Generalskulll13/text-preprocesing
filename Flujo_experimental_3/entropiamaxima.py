...
# Dataset Path
DATASET_PATH = "../Flujo_experimental_3/dataset.csv"
...
def main():
    text_data_headers = []
    archivo1=open("Flujo_experimental_3/listadepalabras.txt",'r')
    archivo2=open("Flujo_experimental_3/resultados.txt",'w')
    for linea in archivo1.readlines():
        text_data_headers.append(limpiasaltolinea(linea))    

    text_data = pd.read_csv('Flujo_experimental_3/dataset.csv', names=text_data_headers)
