...
def ngram(words,n):
	...
	return output
archivo=open("Trigrama3/LLNcooperativa.txt",'r')
archivo1=open("Trigrama3/lema1.txt",'w')
archivo2=open('Trigrama3/prueba final.txt','w')
archivo3=open('Trigrama3/stopwords_final.txt','w')
archivo4=open('Trigrama3/prueba_de_matriz.txt','w')
archivo5=open('Trigrama3/listadengrmas.txt','w')
archivo6=open('Trigrama3/dataset.csv','w')
archivo7=open('Trigrama3/listadepalabras.txt','w')
archivo8=open("Trigrama3/diccionarioespañol.txt",'r')
with open('Trigrama3/diccionariolemmatization.txt', 'rb') as fichero:
...
topico=open("Trigrama3/topicos.txt",'r')
topicos=[]
