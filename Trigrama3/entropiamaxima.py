...
def main():
    text_data_headers = []
    archivo1=open("Trigrama3/listadepalabras.txt",'r')
    archivo2=open("Trigrama3/resultados.txt",'w')
    for linea in archivo1.readlines():
        text_data_headers.append(limpiasaltolinea(linea))
        print("estoy leyendo")
    

    text_data = pd.read_csv('Trigrama3/dataset.csv', names=text_data_headers)
