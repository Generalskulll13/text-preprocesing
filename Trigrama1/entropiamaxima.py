...
# Dataset Path
DATASET_PATH = "../Trigrama1/dataset.csv"
...
def main():
    text_data_headers = []
    archivo1=open("Trigrama1/listadepalabras.txt",'r')
    archivo2=open("Trigrama1/resultados.txt",'w')
    for linea in archivo1.readlines():
        text_data_headers.append(limpiasaltolinea(linea))
        print("estoy leyendo")
    

    text_data = pd.read_csv('Trigrama1/dataset.csv', names=text_data_headers)
