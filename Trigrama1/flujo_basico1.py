...
def ngram(words,n):
	...
	return output
archivo=open("Trigrama1/LLNcooperativa.txt",'r')
archivo1=open("Trigrama1/lema1.txt",'w')
archivo2=open('Trigrama1/prueba final.txt','w')
archivo3=open('Trigrama1/stopwords_final.txt','w')
archivo4=open('Trigrama1/prueba_de_matriz.txt','w')
archivo5=open('Trigrama1/listadengrmas.txt','w')
archivo6=open('Trigrama1/dataset.csv','w')
archivo7=open('Trigrama1/listadepalabras.txt','w')
archivo8=open("Trigrama1/diccionarioespañol.txt",'r')
with open('Trigrama1/diccionariolemmatization.txt', 'rb') as fichero:
...
for palabra in lista_nueva:
	...
	archivo7.write('\n')
topico=open("Trigrama1/topicos.txt",'r')
topicos=[]
